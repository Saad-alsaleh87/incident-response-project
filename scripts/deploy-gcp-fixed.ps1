# GCP Deployment Script for Incident Response Simulation (PowerShell) - Fixed Version
...
Write-Host "Installing required gcloud components..." -ForegroundColor Yellow
...
# Create log-based metrics for incident detection (fixed quotes)
